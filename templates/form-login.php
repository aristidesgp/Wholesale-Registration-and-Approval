...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
	...
	<div class="u-column2 col-2">
		...
		<h2><?php _e('Welcome to Our Wholesale Program', 'CSHR'); ?></h2>
		<p><?php _e('Join our exclusive wholesale program to access special pricing, bulk discounts, and more. Register now to become a wholesale customer and enjoy the benefits.', 'CSHR'); ?></p>
